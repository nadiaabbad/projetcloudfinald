        ...
        if (!empty($_FILES['image']['name'])) {
            ...
            if (in_array($imageFileType, $allowedExtensions)) {
                if (move_uploaded_file($_FILES['image']['tmp_name'], $targetFile)) {
                    ...
                    $customVisionEndpoint = "https://predictiongitapp.cognitiveservices.azure.com/"; // Remplacez par votre Custom Vision endpoint
                    $customVisionPredictionKey = "8b6ad715cd9344a8b1583de97f24c1ae"; // Remplacez par votre Custom Vision prediction key
                    $customVisionIterationId = "057147e0-d1b2-4ed1-83a7-a798ecd772e2"; // Remplacez par votre Custom Vision iteration ID
            ...
            echo '<p>Aucune image n\'a été sélectionnée.</p>';
        }
    }
    ?>
